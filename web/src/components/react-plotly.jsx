...
This file is copied from https://github.com/plotly/react-plotly.js/blob/24d81259ea9369074586f1c3d2b7ae9fc3610860/src/factory.js
(MIT licenced)

https://github.com/plotly/react-plotly.js/issues/273
note: issue with plotly: https://github.com/plotly/react-plotly.js/issues/272

Remix docs on this topic: https://remix.run/docs/en/v1/guides/migrating-react-router-app#client-only-components
*/
...
// [todo] sometimes the data payload can be really big, we need to think more about how to make this not slow everything down.
